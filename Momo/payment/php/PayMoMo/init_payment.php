...
$amount = "10000";
$orderId = time() ."";
$returnUrl = "http://localhost/Momo/payment/php/PayMoMo/result.php";
$notifyurl = "http://localhost/Momo/payment/php/PayMoMo/ipn_momo.php";
        ...
        <div class="col-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Initial payment</h3>
                </div>
