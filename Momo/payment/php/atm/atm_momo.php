...
$amount = "10000";
$orderId = time() ."";
$returnUrl = "http://localhost/Momo/payment/php/atm/result_atm.php";
$notifyurl = "http://localhost/Momo/payment/php/atm/ipn_momo.php";
        ...
        <div class="col-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Initial payment ATM</h3>
                </div>
